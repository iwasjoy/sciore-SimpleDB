...
public class RemoteDriverImpl extends UnicastRemoteObject implements RemoteDriver {
    ...
    * returns it.
    * refer to simpledb.remote.RemoteDriver#connect()
    */
   public RemoteConnection connect(String user,String password) throws RemoteException	 {
      return new RemoteConnectionImpl(user, password);
   }	
}
